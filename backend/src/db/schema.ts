...
export const studentProfiles = pgTable("student_profiles", {
  ...
  transferredFromProvince: text("transferred_from_province"),
  transferredFromCommune: text("transferred_from_commune"),
  dropoutReason: text("dropout_reason"),
  isNewlyEnrolled: boolean("is_newly_enrolled"),
  enrolledDate: date("enrolled_date", { mode: "string" }),
  isFullDay: boolean("is_full_day"),
  isBoardingClass: boolean("is_boarding_class"),
  isBoarding: boolean("is_boarding"),
  ethnicity: text("ethnicity"),
  nationality: text("nationality"),
  religion: text("religion"),
  birthPlace: text("birth_place"),
  birthPlaceProvince: text("birth_place_province"),
  birthPlaceCommune: text("birth_place_commune"),
  birthCertProvince: text("birth_cert_province"),
  birthCertCommune: text("birth_cert_commune"),
  nativePlaceProvince: text("native_place_province"),
  nativePlaceCommune: text("native_place_commune"),
  nativePlaceVillage: text("native_place_village"),
  permanentProvince: text("permanent_province"),
  permanentCommune: text("permanent_commune"),
  permanentHamlet: text("permanent_hamlet"),
  currentAddressDetail: text("current_address_detail"),
  currentProvince: text("current_province"),
  currentCommune: text("current_commune"),
  currentHamlet: text("current_hamlet"),
  ...
  policyTarget: text("policy_target"),
  tuitionExempt: boolean("tuition_exempt"),
  tuitionReduced: boolean("tuition_reduced"),
  studyCostSupport: boolean("study_cost_support"),
  lunchSupport: boolean("lunch_support"),
  languageFamiliarization: boolean("language_familiarization"),
  motherEthnicity: text("mother_ethnicity"),
  fatherEthnicity: text("father_ethnicity"),
  knowsSwimming: boolean("knows_swimming"),
  eyeDisease: boolean("eye_disease"),
  parentHasSmartphone: boolean("parent_has_smartphone"),
  parentHasComputerInternet: boolean("parent_has_computer_internet"),
  childDevelopmentNotes: text("child_development_notes"),
  createdAt: timestamp("created_at").defaultNow().notNull(),
  updatedAt: timestamp("updated_at").defaultNow().notNull(),
});
...
export const storageObjects = pgTable(
  ...
  (t) => [
    unique("storage_objects_school_key_unique").on(t.schoolId, t.objectKey),
    index("storage_objects_school_owner_idx").on(t.schoolId, t.ownerId),
  ],
);
...
export const notifications = pgTable(
  ...
  (t) => [
    index("notifications_school_recipient_created_idx").on(
      t.schoolId,
      t.recipientId,
      t.createdAt,
    ),
    index("notifications_school_recipient_read_idx").on(
      t.schoolId,
      t.recipientId,
      t.readAt,
    ),
...
export const reportJobs = pgTable(
  ...
  (t) => [
    index("report_jobs_school_created_idx").on(t.schoolId, t.createdAt),
    index("report_jobs_school_status_idx").on(t.schoolId, t.status),
  ],
);
